...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_BSPC,   KC_LGUI,   KC_SPC,                     KC_RALT,  KC_RGUI,  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    _______,  _______,  _______,                      KC_DEL,   _______,  KC_ENT,   _______,  _______,  _______,  _______,  _______,  _______
  ),
};
